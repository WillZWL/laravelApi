...
class PricingController extends Controller
{
    ...
    public function index(Request $request, $mp = 'amazon')
    {
        $request->flash();
        $marketplaces = Marketplace::whereStatus(1)->where('id', 'like', "%{$mp}%")->get(['id']);
        ...
        return response()->view('v3.pricing.index', compact('marketplaces', 'skuList', 'data', 'mp'));
    }
