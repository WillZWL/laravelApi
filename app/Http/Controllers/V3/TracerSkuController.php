...
class TracerSkuController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $topCategories = (new  \App\Http\Controllers\MarketplaceCategoryController())->showTopCategoriesForControlId($tracerSku->mp_control_id);
        $selectedSubCategory = MpCategory::find($tracerSku->mp_sub_category_id);

        return view('v3.setting-form', compact('tracerSku', 'mpControls', 'topCategories', 'selectedSubCategory'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/v3/tracer/'.$id.'/edit');
    }
