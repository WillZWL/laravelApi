...
class IwmsCreateCourierOrderService
{
    ...
    public function getCourierOrderCreationRequest($warehouseIds)
    {
        $deliveryCreationRequest = null;
        $batchRequest = $this->getCourierOrderCreationRequestBatch($warehouseIds);
    ...
    public function getCourierOrderCreationRequestBatch($warehouseIds)
    {
    ...
    public function getEsgAllocateCourierOrders()
    {
