...
<section id="header">
  <p class="title">
    {{ ucfirst($mp) }} Pricing Tool
  </p>
</section>

@include('v3.pricing.search-form')
          ...
          <table class="table table-condensed table-responsive table-striped table-hover table-bordered">
            ...
            @forelse($skuList as $item)
              <tr class="marketplaceSku">
                <td class="col-md-4">
                  <a data-pjax id="{{ $item->marketplace_sku }}" href="{{ url('/v3/pricing/index').'?marketplace='.old('marketplace').'&search='.old('search').'&marketplaceSku='.$item->marketplace_sku }}">
