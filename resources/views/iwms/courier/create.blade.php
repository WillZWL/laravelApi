                    ...
                    @if(isset($courierOrderList))
                        @foreach($courierOrderList as $courierOrder)
                            <tr>
                                ...
                                <td>
                                    <a href="/iwms/courier-order/AWB?so_no={{ $courierOrder->reference_no }}">downloand</a>
                                </td>
                                <td>
                                    <a href="/iwms/courier-order/invoice?so_no={{ $courierOrder->reference_no }}">downloand</a>
                                </td>
                                <td>
                                    <a href="/iwms/courier-order/dnote?so_no={{ $courierOrder->reference_no }} ">downloand</a>
                                </td>
